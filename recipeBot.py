...
items = ['Elemental Army','Bone Ring','Calling Wand','+1 Minion Helm','+2 Minion Helm','+3 Minion Helm','Vaal Summon Skeletons','The Dark Mage (Div)','The Brawny Battle Mage (Div)',
        ...
        'Herald of Ice','Herald of Thunder','Herald of Ash','Minion Resist Flask','Minion Life Flask','Bone Ring with Resists','Queens Decree','Midnight Bargain','Alberons Warpath',
        'Lab Enchanted Minion Helmet Damage 20% Chance to Summon Additional','Lab Enchanted Minion Helmet 40% Chance to Summon Additional','From Dust','To Dust','Earendels Embrace',
        'Femurs of the Saints','The Iron Mass']
itemsToOutput = []
